...
export const ALL_ITEMS: GameItem[] = [
  ...
  // ==================== 消耗品 — 灵宠食物 ====================
  {
    id: 'spirit_beast_meat',
    name: '灵兽肉',
    type: 'consumable',
    subtype: '灵宠食物',
    description: '蕴含灵气的兽肉，灵宠食用后可恢复生命。',
    quantity: 1,
    effects: [{ attribute: 'hp', operation: 'add', value: 20, duration: 'instant' }],
    value: 8,
    stackable: true,
    maxStack: 30,
  },
  {
    ...
    type: 'consumable',
    subtype: '灵宠食物',
    description: '汲取天地灵气生长的果实，灵宠最爱的美味点心。',
    quantity: 1,
    effects: [
      { attribute: 'hp', operation: 'add', value: 15, duration: 'instant' },
      { attribute: 'stamina', operation: 'add', value: 10, duration: 'instant' },
    ],
    value: 6,
    stackable: true,
    maxStack: 30,
  },
  {
    ...
    type: 'consumable',
    subtype: '灵宠食物',
    description: '含有微弱灵力的碎石，部分灵宠（如玄龟）以此为食。',
    quantity: 1,
    effects: [{ attribute: 'hp', operation: 'add', value: 5, duration: 'instant' }],
    value: 3,
    stackable: true,
    maxStack: 50,
  },
  ...
  },
  {
    ...
    type: 'consumable',
    subtype: '灵宠食物',
    description: '强大妖兽陨落后凝结的精华，灵宠吸收后可永久增强。',
    quantity: 1,
    effects: [
      { attribute: 'hp', operation: 'add', value: 30, duration: 'instant' },
      { attribute: 'maxHp', operation: 'add', value: 5, duration: 'permanent' },
    ],
    value: 30,
    stackable: true,
    maxStack: 10,
  },
  {
    ...
    type: 'consumable',
    subtype: '灵宠食物',
    description: '蕴含雷霆之力的结晶，雷属性灵宠（如雷鹏）食用后可大幅恢复。',
    quantity: 1,
    effects: [{ attribute: 'hp', operation: 'add', value: 25, duration: 'instant' }],
    value: 25,
    stackable: true,
    maxStack: 15,
  },
  {
    ...
    type: 'consumable',
    subtype: '灵宠食物',
    description: '蕴含极寒之力的晶体，冰属性灵宠（如冰凤）食用后可大幅恢复。',
    quantity: 1,
    effects: [{ attribute: 'hp', operation: 'add', value: 25, duration: 'instant' }],
    value: 25,
    stackable: true,
  ...
  },
  {
    ...
    type: 'consumable',
    subtype: '灵宠食物',
    description: '蕴含古老龙族力量的晶体，龙族灵宠（如古龙）最为喜爱。',
    quantity: 1,
    effects: [{ attribute: 'hp', operation: 'add', value: 40, duration: 'instant' }],
    value: 50,
    stackable: true,
    maxStack: 10,
  },
  ...
  },
  {
    ...
    type: 'material',
    subtype: '灵草',
    description: '风蛇陨落后凝聚的风属性精华，蕴含风之法则。',
    quantity: 1,
    effects: [],
    value: 30,
    stackable: true,
  ...
  },
  {
    ...
    type: 'material',
    subtype: '矿石',
    description: '一块完整的灵石，比碎片蕴含更充沛的灵力，可兑换大量货币。',
    quantity: 1,
    effects: [],
    value: 15,
    stackable: true,
  ...
  },
  {
    ...
    type: 'material',
    subtype: '妖兽材料',
    description: '灵溪蟒的蛇胆，是炼制解毒丹药的珍贵材料。',
    quantity: 1,
    effects: [],
    value: 25,
    stackable: true,
  ...
  },
  {
    ...
    type: 'material',
    subtype: '灵草',
    description: '生长在灵气充沛之地的药草，炼丹常用材料。',
    quantity: 1,
    effects: [],
    value: 8,
    stackable: true,
  ...
  },
  {
    ...
    type: 'material',
    subtype: '妖兽材料',
    description: '毒蛛吐出的丝线，柔韧异常，可用于缝制高级衣物。',
    quantity: 1,
    effects: [],
    value: 15,
    stackable: true,
  ...
  },
  {
    ...
    type: 'material',
    subtype: '妖兽材料',
    description: '毒蛛的毒囊，蕴含剧毒，可用于制毒或炼制特殊丹药。',
    quantity: 1,
    effects: [],
    value: 20,
    stackable: true,
  ...
  },
  {
    ...
    type: 'material',
    subtype: '妖兽材料',
    description: '洞穴蝙蝠的翅膀，质地轻盈，可用于炼制轻身法宝。',
    quantity: 1,
    effects: [],
    value: 8,
    stackable: true,
  ...
  },
  {
    ...
    type: 'material',
    subtype: '矿石',
    description: '矿洞中特有的回音矿石，敲击可发出悠长回响。',
    quantity: 1,
    effects: [],
    value: 18,
    stackable: true,
  ...
  },
  {
    ...
    type: 'material',
    subtype: '矿石',
    description: '地底深处凝结的土属性结晶，蕴含厚重的大地之力。',
    quantity: 1,
    effects: [],
    value: 50,
    stackable: true,
  ...
  },
  {
    ...
    type: 'material',
    subtype: '妖兽材料',
    description: '石魔的核心，凝聚了石魔全部的生命精华。',
    quantity: 1,
    effects: [],
    value: 45,
    stackable: true,
  ...
  },
  {
    ...
    type: 'material',
    subtype: '矿石',
    description: '精炼后的灵矿锭，是锻造高级灵器的优质材料。',
    quantity: 1,
    effects: [],
    value: 40,
    stackable: true,
  ...
  },
  {
    ...
    type: 'material',
    subtype: '妖兽材料',
    description: '守护灵陨落后留下的核心，蕴含庞大的灵力。',
    quantity: 1,
    effects: [{ attribute: 'cultivation', operation: 'add', value: 25, duration: 'instant' }],
    value: 60,
    stackable: true,
    maxStack: 5,
  },
  {
    ...
    type: 'material',
    subtype: '矿石',
    description: '古修洞府中的上古灵玉，蕴含古老的传承之力。',
    quantity: 1,
    effects: [],
    value: 80,
    stackable: true,
  ...
  },
  {
    ...
    type: 'material',
    subtype: '残卷',
    description: '记录了上古功法的残破卷轴，参悟后可获得大量修炼经验。',
    quantity: 1,
    effects: [{ attribute: 'cultivation', operation: 'add', value: 20, duration: 'instant' }],
    value: 100,
    stackable: true,
    maxStack: 10,
  },
  {
    id: 'spirit_weapon_fragment',
    name: '灵器碎片',
    type: 'material',
    subtype: '矿石',
    description: '破碎灵器的残片，仍残留着微弱灵力，可用于修复或锻造。',
    quantity: 1,
    effects: [],
    value: 75,
    stackable: true,
...
export function getShopInventory(npcId: string): GameItem[] {
  switch (npcId) {
    ...
    default:
      // 默认商人库存
      return ['revival_pill', 'spirit_gathering_pill', 'spirit_herb', 'spirit_beast_meat']
        .map((id) => getItemById(id))
        .filter((i): i is GameItem => i !== undefined);
  }
}
